...
foreach(i=1:17) %dopar% getNflLabModel("2015",modelSite=site,modelWeek=i,mod=labsModel,PositionID="QB")
foreach(i=1:17) %dopar% getNflLabModel("2016",modelSite=site,modelWeek=i,mod=labsModel,PositionID="QB")

readQB16 <- foreach(i=1:17) %dopar% readNFLCSVs("2016",modelSite=site,modelWeek=i,modelId=labsModel,PositionID = "QB")
readQB15 <- foreach(i=1:17) %dopar% readNFLCSVs("2015",modelSite=site,modelWeek=i,modelId=labsModel,PositionID = "QB")
QB <- bind_rows(readQB15,readQB16)
#QB <- bind_rows(readQB16)


QBModel <- getNflLabModel("2016",modelSite=site,modelWeek=week,PositionID = "QB")
QBModel <- na.zero(readNFLCSVs("2016",modelSite=site,modelWeek=week,PositionID = "QB"))
...
write.csv(QBFile, file = paste0("QBP",week,"FanDuel.csv"))
QBFile

#______________________________RB
foreach(i=1:17) %dopar% getNflLabModel("2015",modelSite=site,modelWeek=i,mod=labsModel,PositionID="RB")
foreach(i=1:17) %dopar% getNflLabModel("2016",modelSite=site,modelWeek=i,mod=labsModel,PositionID="RB")

readRB16 <- foreach(i=1:17) %dopar% readNFLCSVs("2016",modelSite=site,modelWeek=i,modelId=labsModel,PositionID = "RB")
readRB15 <- foreach(i=1:17) %dopar% readNFLCSVs("2015",modelSite=site,modelWeek=i,modelId=labsModel,PositionID = "RB")
RB <- bind_rows(readRB15,readRB16)
#RB <- bind_rows(readRB16)

RBModel <- getNflLabModel("2016",modelSite=site,modelWeek=week,PositionID = "RB")
RBModel <- na.zero(readNFLCSVs("2016",modelSite=site,modelWeek=week,PositionID = "RB"))
...
write.csv(RBFile, file = paste0("RBP",week,"FanDuel.csv"))
RBFile

#_________________________________WR
foreach(i=1:17) %dopar% getNflLabModel("2015",modelSite=site,modelWeek=i,mod=labsModel,PositionID="WR")
foreach(i=1:17) %dopar% getNflLabModel("2016",modelSite=site,modelWeek=i,mod=labsModel,PositionID="WR")

readWR16 <- foreach(i=1:17) %dopar% readNFLCSVs("2016",modelSite=site,modelWeek=i,modelId=labsModel,PositionID = "WR")
readWR15 <- foreach(i=1:17) %dopar% readNFLCSVs("2015",modelSite=site,modelWeek=i,modelId=labsModel,PositionID = "WR")
WR <- bind_rows(readWR15,readWR16)
#WR <- bind_rows(readWR16)

WRModel <- getNflLabModel("2016",modelSite=site,modelWeek=week,PositionID = "WR")
WRModel <- na.zero(readNFLCSVs("2016",modelSite=site,modelWeek=week,PositionID = "WR"))
...
write.csv(WRFile, file = paste0("WRP",week,"FanDuel.csv"))
WRFile

#_____________________________TE
foreach(i=1:17) %dopar% getNflLabModel("2015",modelSite=site,modelWeek=i,mod=labsModel,PositionID="TE")
foreach(i=1:17) %dopar% getNflLabModel("2016",modelSite=site,modelWeek=i,mod=labsModel,PositionID="TE")

readTE16 <- foreach(i=1:17) %dopar% readNFLCSVs("2016",modelSite=site,modelWeek=i,modelId=labsModel,PositionID = "TE")
readTE15 <- foreach(i=1:17) %dopar% readNFLCSVs("2015",modelSite=site,modelWeek=i,modelId=labsModel,PositionID = "TE")
TE <- bind_rows(readTE15,readTE16)
#TE <- bind_rows(readTE16)

TEModel <- getNflLabModel("2016",modelSite=site,modelWeek=week,PositionID = "TE")
TEModel <- na.zero(readNFLCSVs("2016",modelSite=site,modelWeek=week,PositionID = "TE"))
...
write.csv(TEFile, file = paste0("TEP",week,"FanDuel.csv"))
TEFile

#_________________________________________DST
foreach(i=1:17) %dopar% getNflLabModel("2015",modelSite=site,modelWeek=i,mod=labsModel,PositionID = "DST")
foreach(i=1:17) %dopar% getNflLabModel("2016",modelSite=site,modelWeek=i,mod=labsModel,PositionID = "DST")

readDST16 <- foreach(i=1:17) %dopar% readNFLCSVs("2016",modelSite=site,modelWeek=i,modelId=labsModel,PositionID = "DST")
readDST15 <- foreach(i=1:17) %dopar% readNFLCSVs("2015",modelSite=site,modelWeek=i,modelId=labsModel,PositionID = "DST")
DST <- bind_rows(readDST15,readDST16)
#DST <- bind_rows(readDST16)

DSTModel <- getNflLabModel("2016",modelSite=site,modelWeek=week,PositionID = "DST")
DSTModel <- na.zero(readNFLCSVs("2016",modelSite=site,modelWeek=week,PositionID = "DST"))
...
#write.csv(DSTFile, file = paste0("DSTP",week,"FanDuel.csv"))
#DSTFile
...
write.csv(AllProj, file = paste0("~/Desktop/NFL_Daily/NFL_2016_Week",week,"/AllProjections",week,"FanDuel.csv"))
